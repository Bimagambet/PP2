...
cconn = psg.connect(host="localhost", dbname="phone", user="postgres", password="sultan06", port=5432)
...
insert('Qaz', '1234097532')



#3 inserting from list with loop
lst = [
    ["Aliman", "Bibolov", "87775869534"],
    ["Kairat", "Nurtas", "8772956412"],
    ["Miras", "Jugunusov", "87789315678"]
]
